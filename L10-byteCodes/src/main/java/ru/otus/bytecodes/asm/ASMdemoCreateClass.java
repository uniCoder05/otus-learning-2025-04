...
public class ASMdemoCreateClass {
    private static final Logger logger = LoggerFactory.getLogger(ASMdemoCreateClass.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        cw.visit(Opcodes.V20, Opcodes.ACC_PUBLIC, className, null, "java/lang/Object", null);
        ...
        var helloWorldClass = new MyClassLoader().defineClass(className, cw.toByteArray());
