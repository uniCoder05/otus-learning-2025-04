...
public class ClientsWebServerSimple implements ClientsWebServer {
    ...
    public ClientsWebServerSimple(
            int port, ClientController clientController, Gson gson, TemplateProcessor templateProcessor) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(
                new ServletHolder(new ClientsServlet(templateProcessor, clientController)), "/clients");
        servletContextHandler.addServlet(
                new ServletHolder(new ClientsApiServlet(clientController, gson)), "/api/clients");
        return servletContextHandler;
    }
}
