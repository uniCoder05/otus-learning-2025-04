...
public class MonadExample {
    ...
    public static void main(String[] args) {
        ...
        result = monadExample.notGood(null);
        logger.info(result);

        result = monadExample.good(null);
        logger.info(result);
    }
    ...
    // еще некорректное использование монады
    private String notGood(String str) {
        return Optional.ofNullable(str).map(String::toUpperCase).orElse("param is NULL_notGood");
    }
