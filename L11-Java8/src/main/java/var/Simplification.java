...
public class Simplification {
    ...
    private static String func() {
        try {
            ...
            try (InputStream inputStream = new BufferedInputStream(new FileInputStream("./L11-Java8/lines.txt"));
    ...
    private static String funcVar() {
        try {
            ...
            try (var inputStream = new BufferedInputStream(new FileInputStream("./L11-Java8/lines.txt"));
    ...
    // пример, в котором var не подойдет, хотя Idea тут поможет и методы надо называть норально
    void funcNotGood() {
